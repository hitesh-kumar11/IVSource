...
namespace IVSource.Models
{
    public static class Captcha
    {
        ...
        public static IvsVisaSubscribeToUs GenerateCaptchaImage(int width, int height, string captchaCode)
        {
            ...
            using (Graphics graph = Graphics.FromImage(baseMap))
            {
                ...
                return new IvsVisaSubscribeToUs { CaptchaCode = captchaCode, CaptchaByteData = ms.ToArray(), Timestamp = DateTime.Now };
        ...
        internal static bool ValidateCaptchaCode(object captchaCode, HttpContext httpContext)
        {
