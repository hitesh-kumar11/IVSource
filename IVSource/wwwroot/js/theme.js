...
jQuery(document).ready(function ($) {
    ...
    jQuery("#menu-item-5850 > a").on("click", function () { //*
        isContact = true;
    });
});
jQuery(document).ready(function () {
    // jQuery("#menu-item-5850 > a").on("click", function(){
    // 	setNavActive("contactDiv");
    // 	alert("4");
    // });
    ...
    // $("#menu-item-5850 a").click(function(){
    // 	alert("2");
    // });

    // jQuery("#menu-item-5850 a").click(function(){
    // 	alert("1");
    // });

});

// $("#menu-item-5850 a").on("click", function(e) {
// 	e.preventDefault();
// //$( "" ).click(function() {
// 	setNavActive("contactDiv");
// 	//setNavActive("contactDiv");
